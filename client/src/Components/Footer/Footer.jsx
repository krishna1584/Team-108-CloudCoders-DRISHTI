                ...
                <div className="row">
                  <div className="col-lg-5 footer_logo mb-4 mb-lg-0">
                    ...
                    <p className="footer_text" style={{ textAlign: "justify" }}>
                      At DRISHTI , we're dedicated to making Secure website
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-lg-3 mb-4 mb-lg-0">
                    ...
                    <p>
                      <a
                        href="https://www.linkedin.com/in/KannanGarg/"
                        className="footer_social_media_icon"
                        style={{ color: "white" }}
                      >
                        <BsLinkedin size={25} />
                  ...
                  <div className="col-12 footer_credits text-center">
                    <span>
                      © 2025<a>DRISHTI</a>™. All Rights Reserved.
                    </span>
                  </div>
                </div>
              </div>
